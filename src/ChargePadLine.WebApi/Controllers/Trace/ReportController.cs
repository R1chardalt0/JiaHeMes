...
namespace ChargePadLine.WebApi.Controllers.Trace
{
    ...
    public class ReportController : BaseController
    {
        ...
        /// <summary>
        /// 获取当日每小时产出统计
        /// 按小时统计当日的生产数据，包括产出数量、合格数量和不合格数量
        /// </summary>
        ...
        public async Task<IActionResult> GetHourlyOutput(Guid? productionLineId = null, Guid? workOrderId = null)
        {
            try
            {
                var result = await _reportService.GetHourlyOutputAsync(productionLineId, workOrderId);
