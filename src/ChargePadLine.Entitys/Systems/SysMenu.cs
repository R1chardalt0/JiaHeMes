        ...
        public void Configure(EntityTypeBuilder<SysMenu> builder)
        {
            ...
            var menus = new[]
            {
                new SysMenu
                {
                    ...
                    OrderNum = 1,
                    Path = "/history/device",
                    Component = "History/DeviceTraceInfo/index",
                    Query = null,
                    RouteName = null,
                    IsFrame = "1",
                    IsCache = "0",
                    ...
                    CreateBy = "admin",
                    CreateTime = new DateTimeOffset(2025, 12, 10, 10, 53, 26, 88, TimeSpan.FromHours(8)),
                    Remark = "设备信息追溯菜单"
                },
                new SysMenu
                {
                ...
                new SysMenu
                {
                    ...
                    Perms = null,
                    Icon = "message",
                    CreateTime = new DateTimeOffset(2025, 12, 15, 11, 54, 33, 685, TimeSpan.FromHours(8)),
                    Remark = null
                },
                new SysMenu
                {
                ...
                new SysMenu
                {
                    ...
                    CreateTime = new DateTimeOffset(2025, 11, 21, 9, 14, 41, 875, TimeSpan.FromHours(8)),
                    Remark = null
                },
                new SysMenu
                {
                ...
                new SysMenu
                {
                    ...
                    Perms = null,
                    Icon = null,
                    CreateTime = new DateTimeOffset(2025, 11, 21, 9, 14, 41, 918, TimeSpan.FromHours(8)),
                    Remark = null
                },
                new SysMenu
                {
                    ...
                    ParentId = 3,
                    OrderNum = 2,
                    Path = "/devicemonitor/index2",
                    Component = "device/monitor/index2",
                    Query = null,
                    RouteName = null,
                    IsFrame = "1",
                    IsCache = "0",
                    ...
                    Perms = null,
                    Icon = null,
                    CreateTime = new DateTimeOffset(2025, 11, 21, 9, 14, 41, 923, TimeSpan.FromHours(8)),
                    Remark = null
                },
                new SysMenu
                {
                    ...
                    ParentId = 3,
                    OrderNum = 3,
                    Path = "/devicechart/monitor/:deviceType",
                    Component = "device/monitor/monitor",
                    Query = null,
                    RouteName = null,
                    IsFrame = "1",
                    IsCache = "0",
                    ...
                    Perms = null,
                    Icon = null,
                    CreateTime = new DateTimeOffset(2025, 11, 21, 9, 14, 41, 927, TimeSpan.FromHours(8)),
                    Remark = null
                },
                new SysMenu
                {
                ...
                new SysMenu
                {
                    ...
                    Icon = "bank",
                    CreateTime = new DateTimeOffset(2025, 11, 21, 9, 14, 41, 954, TimeSpan.FromHours(8)),
                    Remark = null
                },
                new SysMenu
                {
                ...
                new SysMenu
                {
                    ...
                    Perms = null,
                    Icon = null,
                    CreateTime = new DateTimeOffset(2025, 11, 21, 9, 14, 41, 969, TimeSpan.FromHours(8)),
                    Remark = null
                },
                new SysMenu
                {
                    ...
                    Perms = null,
                    Icon = null,
                    CreateTime = new DateTimeOffset(2025, 11, 21, 9, 14, 41, 974, TimeSpan.FromHours(8)),
                    Remark = null
                },
                new SysMenu
                {
                    ...
                    Component = "Trace/DeviceTraceInfo",
                    Query = null,
                    RouteName = null,
                    IsFrame = "1",
                    IsCache = "0",
                    ...
                    Perms = null,
                    Icon = null,
                    CreateTime = new DateTimeOffset(2025, 11, 21, 9, 14, 41, 978, TimeSpan.FromHours(8)),
                    Remark = null
                },
                new SysMenu
                {
