...
namespace ChargePadLine.Entitys.Systems
{
    ...
    public class SysRoleMenuClaimEntityConfiguration : IEntityTypeConfiguration<SysRoleMenu>
    {
        public void Configure(EntityTypeBuilder<SysRoleMenu> builder)
        {
            ...
            new SysRoleMenu { Id = 10, RoleId = 1, MenuId = 304 },
            new SysRoleMenu { Id = 11, RoleId = 1, MenuId = 305 },
            new SysRoleMenu { Id = 12, RoleId = 1, MenuId = 306 },
            new SysRoleMenu { Id = 13, RoleId = 1, MenuId = 4   },
            new SysRoleMenu { Id = 14, RoleId = 1, MenuId = 401 },
            new SysRoleMenu { Id = 15, RoleId = 1, MenuId = 402 },         
            new SysRoleMenu { Id = 16, RoleId = 1, MenuId = 5 },
            new SysRoleMenu { Id = 17, RoleId = 1, MenuId = 501 },
            new SysRoleMenu { Id = 18, RoleId = 1, MenuId = 502   },
            new SysRoleMenu { Id = 19, RoleId = 1, MenuId = 6 },
            new SysRoleMenu { Id = 20, RoleId = 1, MenuId = 601 }
        };
