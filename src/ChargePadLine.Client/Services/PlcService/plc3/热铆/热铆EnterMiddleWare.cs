...
namespace ChargePadLine.Client.Services.PlcService.plc3.热铆
{
    public class 热铆EnterMiddleWare : IPlc3Task
    {
        ...
        public 热铆EnterMiddleWare(ILogger<热铆EnterMiddleWare> logger, ILogService logService, 热铆EnterModel enterModel, IOptions<StationConfig> stationconfig , IMesApiService mesApi)
        {
            _logger = logger;
