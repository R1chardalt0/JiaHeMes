...
namespace ChargePadLine.Client.Services.PlcService.plc5.转子充磁与装配
{
    public class 转子充磁与装配MasterMiddleWare : IPlc5Task
    {
        ...
        public 转子充磁与装配MasterMiddleWare(ILogger<转子充磁与装配MasterMiddleWare> logger, ILogService logService, IOptions<StationConfig> stationconfig, IMesApiService mesApi)
        {
            _logger = logger;
