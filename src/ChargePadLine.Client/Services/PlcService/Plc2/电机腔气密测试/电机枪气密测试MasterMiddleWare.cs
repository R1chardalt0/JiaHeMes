...
{
    public class 电机枪气密测试MasterMiddleWare : IPlc2Task
    {
        private readonly ILogger<电机枪气密测试MasterMiddleWare> _logger;
        ...
        public 电机枪气密测试MasterMiddleWare(ILogger<电机枪气密测试MasterMiddleWare> logger, ILogService logService, IOptions<StationConfig> stationconfig, IMesApiService mesApi)
        {
            _logger = logger;
