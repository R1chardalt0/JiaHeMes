...
namespace ChargePadLine.Client.ViewModels
{
    public class 转子充磁And装配ViewModel: ViewModelBase
    {
        ...
        public 转子充磁And装配ViewModel(转子充磁与装配EnterModel 转子充磁与装配EnterModel, 转子充磁与装配ExitModel 转子充磁与装配ExitModel)
        {
            _转子充磁与装配EnterModel = 转子充磁与装配EnterModel;
            _转子充磁与装配ExitModel = 转子充磁与装配ExitModel;

            转子充磁与装配EnterModel.PropertyChanged += (sender, e) =>
            {
                OnPropertyChanged(e.PropertyName);
            };
            转子充磁与装配ExitModel.PropertyChanged += (sender, e) =>
            {
                OnPropertyChanged(e.PropertyName);
            };
        }
