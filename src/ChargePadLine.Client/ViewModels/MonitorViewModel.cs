namespace ChargePadLine.Client.ViewModels
{
    public class MonitorViewModel : ViewModelBase
    {
        ...
        public EOLEnterViewModel EOLEnterViewModel { get; }
        public 安装支架And激光刻印ViewModel 安装支架And激光刻印ViewModel { get; }

        public MonitorViewModel(StatorTestViewModel statorTestViewModel, 导热胶And气密ViewModel 导热胶And气密ViewModel, 性能检查And热铆ViewModel 性能检查And热铆ViewModel, 后盖超声波焊接And干区气密测试ViewModel 后盖超声波焊接And干区气密测试ViewModel, 转子充磁And装配ViewModel 转子充磁And装配ViewModel, 止推垫片装配ViewModel 止推垫片装配ViewModel, 湿区气密ViewModel 湿区气密ViewModel, 旋融焊ViewModel 旋融焊ViewModel, EOLEnterViewModel eOLEnterViewModel, 安装支架And激光刻印ViewModel 安装支架And激光刻印ViewModel)
        {
            ...
            this.EOLEnterViewModel = eOLEnterViewModel;
            this.安装支架And激光刻印ViewModel = 安装支架And激光刻印ViewModel;
        }
    }
}
