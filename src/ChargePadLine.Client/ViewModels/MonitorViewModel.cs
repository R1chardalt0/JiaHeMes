...
namespace ChargePadLine.Client.ViewModels
{
    public class MonitorViewModel : ViewModelBase
    {
        ...
        public MonitorViewModel(StatorTestViewModel statorTestViewModel, 导热胶And气密ViewModel 导热胶And气密ViewModel, 性能检查And热铆ViewModel 性能检查And热铆ViewModel, 后盖超声波焊接And干区气密测试ViewModel 后盖超声波焊接And干区气密测试ViewModel, 转子充磁And装配ViewModel 转子充磁And装配ViewModel)
        {
